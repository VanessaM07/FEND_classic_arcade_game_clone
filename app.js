...
var Player = function(x, y, speed) {
    ...
    this.y = y;
    this.speed = speed;
    this.sprite = 'https://raw.githubusercontent.com/udacity/frontend-nanodegree-arcade-game/master/images/char-horn-girl.png';
};
...
Player.prototype.update = function() {
    ...
    if (this.y < 0) {
        ...
        document.getElementById('lvlScore').innerHTML = score;
        if(score >= 15) {
            alert("Awesome! Can your friend do the same?");
...
var Engine = (function(global) {
    ...
    function render() {
         ...
         */
        var rowImages = [
                'https://raw.githubusercontent.com/udacity/frontend-nanodegree-arcade-game/master/images/water-block.png',   // Top row is 
    ...
    Resources.load([
        ...
        'https://raw.githubusercontent.com/udacity/frontend-nanodegree-arcade-game/master/images/char-horn-girl.png'
    ]);
